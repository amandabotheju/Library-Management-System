...
<head>
  ...
  <title>Admin | Damaged Books</title>
                ...
                <nav>
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <li class="nav-item">
                                <a href="/damaged-Books" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Damaged Books Details</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($books as $book)
                                            <tr>
                                                ...
                                                <td>{{ $book->damaged_quantity }}</td>
                                                <td>
                                                    <a href="" data-toggle="modal" data-target="#book-remove-{{$book->id}}" class="btn btn-info">Remove</a>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content" style="width: 600px;">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('admin.renew')}}" method="POST">
                                                                @csrf
                                                                <div class="form-group row">
                                                                    <input type="hidden" name="id" value="{{$book->id}}">
                                                                    <label for="authorId">Book Count: </label>
                                                                    <div class="col-sm-3">

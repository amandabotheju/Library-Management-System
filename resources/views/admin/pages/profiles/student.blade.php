<div class="modal fade" id="student-details-{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
        
    <?php 
        $id = $user->User_Id;
        $user = DB::table('user_students')->where('Stu_Id', $user->User_Id)->first();
        $borrows = DB::table('student_borrows')->where('User_Id', $id)->orderBy('created_at', 'asc')->take(10)->get();
    ?>
